...
add_action('wp_footer', 'jb_template_add_job_form');
...
add_action('jobboard_loop_after', 'jb_template_job_loop_specialisms_listing', 200);
...
add_action('jobboard_single_summary_after', 'jb_template_job_map', 30);
add_action('jobboard_single_summary', 'jb_template_job_summary_end', 50);
add_action('jobboard_single_summary_after', 'jb_template_job_author');
...
add_action('jobboard_user_employer_content', 'jb_template_user_video', 20);
...
add_action('jobboard_user_candidate_content', 'jb_template_user_video', 20);
...
add_action('jobboard_table_applied_title', 'jb_template_candidate_applied_title', 10);
...
add_filter('the_content', 'jb_build_content_locations_page');