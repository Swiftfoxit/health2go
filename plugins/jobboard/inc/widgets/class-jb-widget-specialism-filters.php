...
class JB_Widget_Specialism_Filters extends JB_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'A Specialism filters box for JobBoard only.', JB_TEXT_DOMAIN );
		$this->widget_id          = 'jobboard-widget-specialism-filters';
		$this->widget_name        = esc_html__( 'JobBoard Specialism Filters', JB_TEXT_DOMAIN );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Sectors', JB_TEXT_DOMAIN ),
            ...
            'parent' => array(
                'type'  => 'checkbox',
                'std'   => 1,
                'label' => esc_html__( 'Hide children', JB_TEXT_DOMAIN )
            ),
			'hide_empty' => array(
				'type'  => 'checkbox',
				'std'   => 0,
