 ...
 *
 * This template can be overridden by copying it to yourtheme/jobboard/add-ons/register/emails/candidate-active.php
 *
...
<p><a href="<?php echo esc_url($candidate->active_url); ?>"><?php echo esc_url($candidate->active_url); ?></a></p>
