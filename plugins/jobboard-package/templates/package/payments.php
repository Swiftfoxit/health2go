...
<div class="package-payments">
    <p><?php esc_html_e('Payment Option:', JB_PACKAGE_TEXT_DOMAIN); ?></p>
    <div class="payments-content">
        <ul class="payments">
            <?php foreach ($payments as $payment => $value): ?>
                <li id="payment-<?php echo esc_attr($payment); ?>" data-id="<?php echo esc_attr($payment); ?>"
                    class="payment payment-<?php echo esc_attr($payment); ?>">
                    ...
                    <?php if (!empty($value['icon'])): ?>
                        ...
                        <div class="patment-icon">
                            <img src="<?php echo esc_url($value['icon']); ?>"
                                 alt="<?php echo esc_html($value['name']); ?>">
                        </div>
        ...
        <div class="actions">
            ...
            <input type="submit" name="package-checkout" class="button submit-button"
                   value="<?php esc_html_e('Process Payment', JB_PACKAGE_TEXT_DOMAIN) ?>">
        </div>
    </div>
