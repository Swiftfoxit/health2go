  ...
  jQuery(document).on('click','.timerange',function(e){
    e.stopPropagation();
    ...
    jQuery('.timerangepicker-container').on(
      'click',
      '.timerangepicker-display.hour .increment',
      function(){
        var value = jQuery(this).siblings('.value');
        value.text(
  ...
  jQuery(document).on('click', e => {
    ...
    if(!jQuery(e.target).closest('.timerangepicker-container').length) {
      if(jQuery('.timerangepicker-container').is(":visible")) {
        var timerangeContainer = jQuery('.timerangepicker-container');
