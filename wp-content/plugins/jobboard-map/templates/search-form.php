...
<div class="map-search-control<?php echo esc_attr($active); ?>">
    <div class="map-search-form">
        <div class="search-form">
            <input class="search-geolocation" type="text" value="" placeholder="<?php esc_html_e('Geo Location', JB_MAP_TEXT_DOMAIN); ?>">
            <input class="search-keyword" type="search" value="<?php echo get_search_query(); ?>" placeholder="<?php esc_html_e('Keyword', JB_MAP_TEXT_DOMAIN); ?>">
            <button class="search-button button">
                <i class="fa fa-search"></i>
                <i class="fa fa-spinner jobboard-loading" style="display: none"></i>
                <span><?php esc_html_e('Search', JB_MAP_TEXT_DOMAIN); ?></span>
            </button>
        </div>
    </div>
</div>
