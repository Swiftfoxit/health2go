...
<h2><?php echo esc_html(sprintf(esc_html__('Hello %s', JB_TEXT_DOMAIN), $candidate->display_name)); ?></h2>
<h4><?php echo esc_html(sprintf(esc_html__('Your Application %s !', JB_TEXT_DOMAIN), $candidate->application)); ?></h4>
