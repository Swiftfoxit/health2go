...
<h2><?php echo sprintf(esc_html__('Hello %s', JB_TEXT_DOMAIN), $candidate->display_name); ?></h2>
<h4><?php esc_html_e('You have applied a job.', JB_TEXT_DOMAIN); ?></h4>
<table style="text-align: left;font-style: italic;">
    ...
    <tr>
        <th><?php esc_html_e('By', JB_TEXT_DOMAIN); ?></th>
    ...
    <tr>
        <th><?php esc_html_e('Applied', JB_TEXT_DOMAIN); ?></th>
        <td><a href="<?php echo esc_url($candidate->manager); ?>"><?php esc_html_e('View', JB_TEXT_DOMAIN); ?></a></td>
    </tr>
    </tbody>
</table>