...
<div class="applications-filter">
    <h5><?php esc_html_e('FILTER', JB_TEXT_DOMAIN); ?></h5>
    <div class="search">
        <input type="search" class="search-field" title="<?php esc_attr_e('Enter user name, user email, application status.', JB_TEXT_DOMAIN); ?>" placeholder="<?php esc_html_e('Search...', JB_TEXT_DOMAIN);?>">
    </div>
