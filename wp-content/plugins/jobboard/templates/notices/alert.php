...
<div class="jobboard-alert">
    ...
    <div class="alert-actions" style="display: none;">
        <button id="actions-yes" type="button" class="button" value="1"><?php esc_html_e('Yes', JB_TEXT_DOMAIN); ?></button>
        <button id="actions-no" type="button" class="button" value="0"><?php esc_html_e('No', JB_TEXT_DOMAIN); ?></button>
    </div>
</div>
