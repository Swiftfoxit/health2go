...
<div class="user-recent">
    <h3><?php echo sprintf(esc_html__( 'Recent Jobs by %s%s%s', JB_TEXT_DOMAIN ), '<span>', jb_account_get_display_name(), '</span>'); ?></h3>
    <div class="jobboard-archive-loop">
        ...
        <?php else: ?>
            ...
            <?php esc_html_e('Recent Jobs Not Found!', JB_TEXT_DOMAIN); ?>
            </div>
        <?php endif; ?>
    </div>
</div>
