...
<div class="single-thumbnail">
    ...
    <?php echo apply_filters('jobboard_single_thumbnail_html', sprintf('<img src="%1$s" class="%2$s" alt="%3$s" itemprop="image">', jb_job_image_url('large'), 'attachment wp-post-image', get_the_title())); ?>
