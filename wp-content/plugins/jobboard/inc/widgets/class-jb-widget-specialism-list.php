...
class JB_Widget_Specialism_List extends JB_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'A list of jobboard specialisms.', JB_TEXT_DOMAIN );
		$this->widget_id          = 'jobboard-widget-specialism-list';
		$this->widget_name        = esc_html__( 'JobBoard Specialism List', JB_TEXT_DOMAIN );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
				'std'   => esc_html__( 'Job Sectors', JB_TEXT_DOMAIN ),
            ...
            'orderby' => array(
                ...
                'options' => array(
                    'order' => esc_html__( 'Term Order', JB_TEXT_DOMAIN ),
            ...
            'count' => array(
                'type'  => 'checkbox',
                'std'   => 1,
                'label' => esc_html__( 'Show counts', JB_TEXT_DOMAIN )
            ),
            'hide_empty' => array(
                'type'  => 'checkbox',
                'std'   => 0,
	...
	public function widget( $args, $instance ) {
        ...
        $list_args['show_option_none']           = esc_html__('Specialism does not exists.', JB_TEXT_DOMAIN );
